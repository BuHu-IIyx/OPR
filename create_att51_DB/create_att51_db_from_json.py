...
class CreateDB:
    def __init__(self, org_name):
        ...
        dict_json_file = 'C:\\Users\\buhu_\\PycharmProjects\\OPR\\output\\Templates\\template\\dict.json'
    ...
    def insert_data(self, mguid, type_rm):
        if type_rm in self.rm_dict.keys():
            ...
            p_dir = f'C:\\Users\\buhu_\\PycharmProjects\\OPR\\output\\Templates\\template\\{type_rm}'
